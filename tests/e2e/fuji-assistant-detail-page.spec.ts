...
test('fuji detail: first load sets both 首次上料條碼 and 當前接料條碼', async ({ page }) => {
    const mockMounterFiles = [{
...
test('fuji detail: blocks second load when 當前接料條碼 already set', async ({ page }) => {
    const mockMounterFiles = [{
        id: 1, file_name: 'test', created_at: '2024-01-01T00:00:00Z', updated_at: null,
        product_idno: '40X85-009B-TEST_SCAN', product_ver: '1',
        mounter_idno: 'XP2B1', board_side: 'TOP',
...
test('fuji detail: unload clears 當前接料條碼 only, re-scan updates it', async ({ page }, testInfo) => {
    const mockMounterFiles = [{
        id: 1, file_name: 'test', created_at: '2024-01-01T00:00:00Z', updated_at: null,
        product_idno: '40X85-009B-TEST_SCAN', product_ver: '1',
        mounter_idno: 'XP2B1', board_side: 'TOP',
