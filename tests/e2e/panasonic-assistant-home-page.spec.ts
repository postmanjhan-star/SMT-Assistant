...
test('panasonic home: normal mode — fill form and navigate to detail page', async ({ page }) => {
    ...
    console.log('Panasonic normal mode: 表單提交完成，已跳轉頁面');
});

test('panasonic home: testing mode — auto-fill defaults and navigate with testing_mode=1', async ({ page }) => {
    await page.goto('http://localhost/smt/panasonic-mounter');
    ...
    console.log('Panasonic testing mode: 試產模式表單提交完成，已跳轉頁面');
});
