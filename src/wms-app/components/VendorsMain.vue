...
import { OpenAPI, VendorRead, VendorsService } from '../../client'
...
const gridOptions: GridOptions = {
  ...
  onRowDoubleClicked: ( event: RowDoubleClickedEvent ) => router.push( `/wms/vendors/${ event.data.idno }` ),
}
...
function handleCreateStoreageButtonClick () { router.push( '/wms/vendors/create' ); }
</script>
